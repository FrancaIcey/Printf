#include "main.h"
	...
	/* WRITE HANDLE */
/**
 * handle_write_char - The function that prints a string
 * @c: A character types
 ...
 * @ind: character types
 * @buffer: A buffer array to handle print
 * @flags: The function that calculates active flags
 * @width: Width.
 * @precision: Precision specifier
 * @size: Size specifier
 *
...
/**
 * write_num - The function to write a number using a bufffer
...
/**
 * write_pointer - A function to write a memory address
 ...
 * @extra_c: A character representing extra an character
